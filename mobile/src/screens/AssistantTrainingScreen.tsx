  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        <Text style={styles.title}>Welcome, Assistant!</Text>
        <Text style={styles.description}>
          This section will provide guidance on how to effectively assist in emergency situations,
          including supporting the primary responder and managing the scene.
        </Text>
